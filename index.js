 ...
 */
// REF: https://github.com/GoogleChromeLabs/sample-media-pwa/blob/4bd0b26b7c87679fc6427f36159a90da3402f051/build/swatch-test.js
const argv = require('yargs').argv;
const Swatch = require('./median-cut');
...
Swatch.load(image)
    ...
    .then(swatch => {
      ...
      `;
        console.log(path.dirname(image), image);
        fs.writeFile(
            `${path.dirname(image)}/swatch(${path.basename(image)}).html`,
            swatchHTML
        );
    });
